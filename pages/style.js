...
export default function KnowYou() {
  ...
  const handleContinue = async () => {
    ...
    // TODO: send data to backend instead of fakeUpload()
    await fakeUpload();

    setUploading(false);
    router.push("/trending"); // change to where you want next
  };
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[430px] mx-auto px-6 pb-10 flex justify-between">
        <button
          onClick={() => router.push("/dashboard")} // or wherever “Skip” should go
